...
export function ZoneQuickNav({ onNavigate }: ZoneQuickNavProps) {
  return (
    <div
      ...
      <div className="flex flex-col gap-1">
        {ZONE_NAV_ITEMS.map(({ key, zoneId }) => {
          ...
          return (
            <button
              key={zoneId}
              className="flex items-center gap-2 text-xs text-gray-400 hover:text-gray-200 transition-colors text-left"
